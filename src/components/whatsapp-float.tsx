...
export function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="fixed bottom-24 end-4 z-50 flex size-12 items-center justify-center rounded-full bg-[#111111] text-white shadow-md transition hover:bg-black md:bottom-6 md:end-6"
    >
