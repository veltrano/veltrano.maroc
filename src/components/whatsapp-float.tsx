...
export function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      aria-label={`WhatsApp ${SHOP_WHATSAPP_DISPLAY}`}
      className="fixed bottom-24 right-4 z-50 flex size-12 items-center justify-center rounded-full bg-[#111111] text-white shadow-md transition hover:bg-black md:bottom-6 md:right-6"
    >
